...
from watcher import scrape_and_update_feed, ScraperRequest, ScraperResult
...
class TestLibraryAPI:
    ...
    @patch('watcher.lib.ContentStorage')
    @patch('watcher.lib.RSSManager')
    def test_scrape_and_update_feed_with_diff(self, mock_rss, mock_storage, mock_scraper):
        ...
        mock_storage_instance.save_content.return_value = ('20250111-140000.html', diff_content)
